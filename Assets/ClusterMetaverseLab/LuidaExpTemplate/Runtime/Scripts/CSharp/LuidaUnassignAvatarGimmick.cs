...
[ExecuteInEditMode]
public class LuidaUnassignAvatarGimmick : LuidaFakeGimmick
{
    protected override string TargetPrefabPath => "ClusterMetaverseLab/LuidaExpTemplate/FakeGimmickSources/UnassignAvatar";

    [Header("Avatar Unassignment Parameters")]
    ...
    private void PatchLogicStatementTargetKey(object globalLogic)
    {
        ...
        {
            Debug.LogWarning($"[LuidaUnassignAvatarGimmick] Could not patch logic statement target key: {e.Message}");
        }
    }
}
#endif

...
public class StateListEditor : EditorWindow
{
    ...
    private string prefabPath = "Assets/_ExpWorld_/Prefabs/StateManagement/State.prefab";
    ...
    private void OnGUI()
    {
		...
		if (stateList == null)
		{
    		string templatePath = "Assets/_ExpWorld_/ExpSettings/StateList/Template.asset";

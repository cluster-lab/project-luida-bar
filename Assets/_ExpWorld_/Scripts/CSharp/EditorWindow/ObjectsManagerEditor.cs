...
public class ObjectsManagerEditor : EditorWindow
{
    ...
    private string conditionDependentObjectPrefabPath = "Assets/_ExpWorld_/Prefabs/ConditionManagement/ConditionDependentObject.prefab";
    private string formPrefabPath = "Assets/_ExpWorld_/Prefabs/Questionnaire/Questionnaire.prefab";
    private string jsStateTemplatePath = "Assets/_ExpWorld_/Scripts/StateManagement/StateDependentObjectTemplate.js";
    private string jsConditionTemplatePath = "Assets/_ExpWorld_/Scripts/ConditionManagement/ConditionDependentObjectTemplate.js";
    ...
    private void DisplayNewObjectRow(string stateName, int stateId, string prefabPath, string jsTemplatePath, string label)
    {
        ...
        {
            AddStateDependentObject(stateName, stateId, objectNames[stateName], prefabPath, jsTemplatePath);
    ...
    private void AddStateDependentObject(string stateName, int stateId, string objectName, string prefabPath, string jsTemplatePath)
    {
        ...
        string scriptFolderPath = $"Assets/_ExpWorld_/Scripts/ConditionManagement/{sceneName}";

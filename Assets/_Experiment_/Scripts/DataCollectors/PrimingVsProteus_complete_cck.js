...
*/
return {
    video:  $.getStateCompat("global", "isElderVideo",   "boolean") ? "Elder" : "Young",
    avatar: $.getStateCompat("global", "isElderAvatar",  "boolean") ? "Elder" : "Young",
    road:   $.getStateCompat("global", "isSafeRoad",     "boolean") ? "Safe"  : "Danger",
};

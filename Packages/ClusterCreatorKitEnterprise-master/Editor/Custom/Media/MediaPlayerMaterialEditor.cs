...
{
    [CustomPropertyDrawer(typeof(MediaPlayerMaterial))]
    public sealed class MediaPlayerMaterialEditor : PropertyDrawer
    {
        ...
        {
            var propMaterial = property.FindPropertyRelative("material");
            ...
            {
                var material = (Material) (propMaterial.objectReferenceValue);
            ...
            using (new EditorGUI.PropertyScope(position, label, property))
            {
                ...
                using (new EditorGUI.IndentLevelScope())
                {
                    ...
                    EditorGUI.PropertyField(new Rect(fieldRect), propMaterial);
